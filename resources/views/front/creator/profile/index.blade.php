                    ...
                    <div class="card mb-4">
                        <div class="card-body text-center gradient-custom">
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <button type="button" class="btn btn-auth"><a href="{{ route('profile.edit', ['profile' => Auth::user()-> id])}}">Edit Profile</a> </button>
                            ...
                            <div class="card mb-4 mb-md-0">
                                <div class="card-body">
                                    ...
                                    @foreach ($projects as $project)
                                        <p class="mb-1" style="font-size: .77rem;">{{$project-> project_name ?? "No Project Assigned"}}</p>
