...
@font-face {
  ...
  font-display: swap;
  src: local(''),
       url('{{ asset('fonts/inter-v12-latin-300.woff2')}}') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */
       url('{{ asset('fonts/inter-v12-latin-300.woff')}}') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
}
...
@font-face {
  ...
  font-display: swap;
  src: local(''),
       url('{{ asset('fonts/inter-v12-latin-500.woff2')}}') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */
       url('{{ asset('fonts/inter-v12-latin-500.woff')}}') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
}
@font-face {
  font-family: 'Inter';
  font-style: normal;
  ...
  font-display: swap;
  src: local(''),
       url('{{ asset('fonts/inter-v12-latin-700.woff2')}}') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */
       url('{{ asset('fonts/inter-v12-latin-700.woff')}}') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
}
...
<div class="container position-relative">
  <div class="col-12 col-lg-8 mt-0 h-100 position-absolute top-0 end-0 bg-cover" data-aos="fade-left" style="background-image: url({{ asset('img/webp/interior11.webp)')}});">
...
<div class="row d-flex justify-content-between align-items-center">
  ...
  <div class="row gx-5 d-flex">
    <div class="col-md-11">
      <div class="shadow ratio ratio-16x9 rounded bg-cover bp-center align-self-end" data-aos="fade-right" style="background-image: url({{ asset('img/webp/people15.webp')}});--bs-aspect-ratio: 50%;">
      </div>
    </div>
    <div class="col-md-5 offset-md-1">
      <div class="shadow ratio ratio-1x1 rounded bg-cover mt-5 bp-center float-end" data-aos="fade-up" style="background-image: url({{ asset('img/webp/interior42.webp')}});">
      </div>
    </div>
    <div class="col-md-6">
      <div class="col-12 shadow ratio rounded bg-cover mt-5 bp-center" data-aos="fade-left" style="background-image: url({{ asset('img/webp/people4.webp')}});--bs-aspect-ratio: 150%;">
      </div>
    </div>
  </div>
</div>
    ...
    <div class="col-12">
      <div class="row vw-100 px-0 py-vh-5 d-flex align-items-center scrollx">
        <div class="col-md-2" data-aos="fade-up">
            <img src="{{ asset('img/webp/interior37.webp')}}" class="rounded shadow img-fluid" alt="nice gallery image" width="512" height="341">
        </div>

        <div class="col-md-2" data-aos="fade-up" data-aos-delay="200">
            <img src="{{asset('img/webp/people1.webp')}}" class="img-fluid rounded shadow" alt="nice gallery image" width="1164" height="776">
        </div>

        <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
            <img src="{{asset('img/webp/people2.webp')}}" class="img-fluid rounded shadow" alt="nice gallery image" width="844" height="1054">
        </div>

        <div class="col-md-3" data-aos="fade-up" data-aos-delay="600">
            <img src="{{asset('img/webp/interior29.webp')}}" class="img-fluid rounded shadow" alt="nice gallery image" width="844" height="562">
        </div>

        <div class="col-md-2" data-aos="fade-up" data-aos-delay="800">
            <img src="{{asset('img/webp/people23.webp')}}" class="rounded shadow img-fluid" alt="nice gallery image" width="512" height="341">
        </div>
      </div>
    </div>
   </div>
...
<div class="col-md-7" data-aos="fade-left">
  <blockquote>
    ...
    <img src="{{ asset('img/webp/person11.webp')}}" width="64" height="64" class="img-fluid rounded-circle me-3" alt="" data-aos="fade">
