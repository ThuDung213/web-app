...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,500;0,700;0,900;1,300&display=swap"
        rel="stylesheet">
...
<body>
    <div id="app">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle d-flex align-items-center"
                                    ...
                                    <img width="38" height="40" class="dropbtn rounded-circle bordered"
        ...
        <main class="py-4" style="background-color: rgb(200, 211, 244)">
            @yield('content')
        </main>
    </div>
